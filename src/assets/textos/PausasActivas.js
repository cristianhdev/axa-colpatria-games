...
export const PausasActivas = [
    {
        "tipo": "recordarSonido",
        "instruccion": "Girar la cabeza de izquierda a derecha y de derecha a izquierda lentamente. <br> -Repetir este movimiento durante 15 segundos.",
        "id": 0,
        "tiempo": 15,
        "cambio": false,
    ...
    {
        "tipo": "recordarSonido",
        "instruccion": "Realizar movimientos laterales de cuello de la siguiente manera: <br> Centro – izquierda – centro – derecha – centro. <br> -Repetir este movimiento durante 15 segundos.",
        "id": 1,
        "tiempo": 15,
        "cambio": false,
    ...
    {
        "tipo": "recordarPosicion",
        "instruccion": "Realizar movimientos de hombros en línea recta hacia adelante y hacia atrás.<br> -Repetir este movimiento durante 10 segundos.",
        "id": 4,
        "tiempo": 10,
        "cambio": false,
    ...
    {
        "tipo": "recordarPosicion",
        "instruccion": "Lleve los hombros hacia arriba y mantenga esta postura de 10 a 15 segundos.<br>Pasado este tiempo vuelva a su posición inicial.",
        "id": 14,
        "tiempo": 15,
    ...
    {
        "tipo": "recordarSonido",
        "instruccion": "<ol><li>Colocar su mano derecha sobre el lado superior izquierdo de su cabeza.</li><li>Ejercer presión hacia su hombro derecho.</li></ol><br>-Mantener postura de 10 a 15 segundos y volver a su postura inicial.<br>Repetir ejercicio hacia el lado izquierdo.",
        "id": 17,
        "tiempo": 30,
        "cambio": true,
    ...
    {
        "tipo": "recordarPosicion",
        "instruccion": "<ol><li>Colocarse de pie. </li><li>Extender los brazos hacia adelante.</li><li>Separar levemente las piernas.</li><li>Flexionar las piernas manteniendo siempre la espalda derecha (simulando que se sienta en el aire).</li></ol><br>- Mantener esta posición durante 15 segundos.<br>OJO, La rodilla no debe pasar la punta del pie.",
        "id": 28,
        "tiempo": 15,
        "cambio": false,
    ...
    {
        "tipo": "concentrese",
        "instruccion": "<ol><li>Sentarse. </li><li>Cruzar los brazos, llevando sus manos sobre cada uno de sus hombros y formando con ellos una “X” sobre su pecho.Tomar una inspiración profunda.</li><li>Girar el tronco lentamente 45° hacia la derecha.</li><li>Regresar al centro. </li><li>Repetir la inspiración.</li><li>Girar el tronco lentamente 45° hacia la izquierda.</li></ol><br> Esto lo debe hacer sin levantar la pelvis del asiento.<br>- Repetir el ejercicio durante 30 segundos o realizar 3 repeticiones por lado.",
        "id": 32,
        "tiempo": 30,
        "cambio": true,
